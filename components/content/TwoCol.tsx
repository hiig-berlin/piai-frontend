...
export const TwoCol = () => {
  return (
    <Grid bg={background}>
      {/* <ImageWrapper><Image src={background} /></ImageWrapper> */}
        <Tile
          bgOverlay="#AA936E"
          element={(
            <LabElement
        ...
        >
          <>
            <p>Defining public interest AI is as difficult as it is crucial for our society. Academia and various societal stakeholder have entered a discourse to sharpen the edges of this explanation.</p>
