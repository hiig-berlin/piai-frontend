...
export const stakeholderList = [
  ...
  },
  {
    ...
    description:
      "CAHAI is a group examining the feasibility and potential elements of a legal framework for the development, design, and application of artificial intelligence based on the Council of Europe's standards for human rights, democracy, and the rule of law, based on extensive consultations with various stakeholders.",
  },
  {
  ...
  },
  {
    ...
    description:
      "The project “AI Campus”, co-organized by the Stifterverband, combines various free introductions to the field of AI - from basic knowledge of understanding the technical processes to practical application in different contexts.",
  },
  {
    name: "AI for Good (European AI ecosystem) -> nicht mehr aktiv",
    tags: ["AI Practice"],
    link: "https://www.aiforgood.eu/",
    location: "Paris, France",
    description:
      "AI for Good bietet eine Vernetzung von europäischen AI4Good Inititativen und Organisation von Labs, beispielsweise zur Förderung von Frauen in KI-Bereichen.",
  },
  {
    ...
    description:
      "The goal of AI for Good is to identify practical applications of AI to advance the United Nations Sustainable Development Goals and scale these solutions for global impact. It is the United Nations' leading action-oriented, global, and inclusive platform for AI.",
  },
  {
    ...
    description:
      "The AI for Good Foundations' goal is to use AI to accelerate and measure impact on the United Nations SDGs. To achieve this goal, the AI for Good Foundation works, for example, with governments, think tanks or non-profit organizations to help develop AI frameworks, provides digital infrastructure or is involved in specific projects such as the “SDG Trand Scanner”.",
  },
  {
    name: "AI.Hamburg",
    tags: ["Politics"],
  ...
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "The non-profit organization “AlgorithmWatch” has set itself the goal of observing and classifying processes of algorithmic decision-making that have social relevance. Those processes are defined as processes that either predict or predetermine human decisions, or make decisions automatically. In this context, AlgorithmWatch naturally also deals with AI and ADM.",
  },
  {
    name: "Amnesty Inernational -> zu wenig informationen",
    tags: [],
    link: "https://amnesty-digital.de/unsere-themen/kuenstliche-intelligenz/",
    location: "",
    description:
      "Amnesty International hat einen eigenen Bereich zu KI auf der Website angelegt,m der einen Überblick zu KI und Menschenrechten geben soll. Es soll sowohl über den problematischen Einsatz von KI, also auch über mögliche positive Einsatzmöglichkeiten aufgeklärt werden. Hier werden beispielsweise KI im Rahmen der “Toxic Twitter”‚ Kampagne zum Aufspüren von Hate Speech, KI zur Auswertung von Satellitenbildern um Menschenrechtsverletzungen belegen zu können sowie die Decoder-Kampagne, welche Menschenrechtsverletzungen und Umweltschäden aufdecken sol, genannt.",
  },
  {
  ...
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "For example, the Charité has an AI project for the treatment or prevention of strokes, but also projects that deal with e.g. image generation to get anonymized training data, as well as Explainable AI.",
  },
  {
    name: "CityLAB Berlin",
  ...
  },
  {
    ...
    location: "Brussels, Belgium",
    description:
      "The “Confederation of Laboratories for Artificial Intelligence Research in Europe” is a cluster of excellence for European AI laboratories and institutions. One focus of the research is on trustworthy AI.",
  },
  {
  ...
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "CorrelAid brings socially minded Data Scientists together with social organizations and thus initiates joint projects. The work therefore mainly consists of networking Data Scientists and non-profit organizations and further education programs for the latter.",
  },
  {
    name: "Data Ethics",
    tags: ["Research", "Think tanks/NGOs"],
  ...
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "Co:Lab offers a network of experts, e.g. in the form of the project “AI in the municipalities” which aims to explore the arising possibilities and usecases of AI for municipalities. Co:Lab does not work exclusively on AI, but also deals with other types of software.",
  },
  {
    name: "Digital Hub Applied Artificial Intelligence Karlsruhe -> zu wirtschaftsorientiert?",
    tags: ["AI Practice"],
    link: "https://digitalhub-ai.de/en/dehub-karlsruhe",
    location: "Karlsruhe, Germany",
    description:
      "The Digital Hub Karlsruhe has set itself the goal of bringing AI methods and technologies into application. To this end, existing AI actors are to be networked and future actors are to be formed.",
  },
  {
  ...
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "The Einstein Center for Digital Future has, among others, a project on AI Empowered Sustainable Urban Mobility Platform (AISUM). The project aims to establish a platform for sustainable urban mobility in which climate protection and resource efficiency are structurally anchored. Users should be able to transparently view the ecological costs of various transport options and be encouraged to use particularly climate-friendly means of transport. ",
  },
  {
    ...
    location: "Brussels, Belgium",
    description:
      "The European AI Fund aims to build civil society organizations with AI expertise and enable them to build strategic capacity in advocacy and policy to shape Europe's digital future in the medium and long term. It also aims to network stakeholders.",
  },
  {
  ...
  },
  {
    ...
    tags: ["Funding", "Politik"],
    link: "https://www.bmfsfj.de/bmfsfj/meta/en",
    location: "Berlin,Germany",
    description:
      "For example, as part of the “Artificial Intelligence for the Common Good” program, the BMFSFJ is funding research, implementation, and model projects that either aim to lay the foundations for public good-oriented AI or develop and test it. ",
  },
  {
    ...
    location: "Berlin,Germany",
    description:
      "For example, under the AI Lighthouses for Environment, Climate, Nature and Resources, the BMUV funded AI projects that seek to address environmental challenges through the means of AI.",
  },
  {
    name: "Federal Ministry of Labour and Social Affairs (BMAS) -> wird das zu viel",
    tags: [],
    link: "https://www.bmas.de/EN/Home/home.html",
    location: "Berlin, Germany",
    description:
      "The BMAS promotes AI projects in particular via the Digital Work Society think tank set up by the BMAS. For example, as part of the New Quality of Work initiative, learning and experimentation spaces for AI applications should be created. On the other hand, more research-oriented projects such as “KITQAR” for the development of quality standards are also funded.",
  },
  {
    ...
    location: "New York, USA",
    description:
      "The Ford Foundation funds public interest tech, which includes public benefit-oriented AI. ",
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "The German AI Association strives to promote non-profit and application-oriented AI projects. For example, it co-initiated the project Unlikely Allies, which aims to link AI developers and climate change activists to initiate AI projects for climate protection.",
  },
  {
    ...
    description:
      "The German Research Center for Artificial Intelligence conducts research in the field of AI according to the principles of social relevance and scientific excellence. One example is the Marine Perception research group, which has projects to remove trash from the oceans or monitor climate change, among other things. There is also a close link here with DFKI4planet, the DFKI Competence Center AI for Environment and Sustainability.",
  },
  {
    ...
    description:
      "Among other things, Germany's platform for artificial intelligence maintains a map of “AI for Sustainability” projects in Germany. The network of experts also aims to promote independent exchange and social dialog on AI.",
  },
  {
    ...
    description:
      "The Gesellschaft für Informatik has, among others, a project on AI Testing & Auditing and a project on Educational Concepts for Data Literacy and Artificial Intelligence (AI) Competencies to embed this into teacher and school education.",
  },
  {
    name: "Google.org",
    tags: ["Funding"],
  ...
  },
  {
    ...
    description:
      "The Hasso Plattner Institute is a co-initiator of the AI Campus and also offers educational programs on AI on its own website.",
  },
  {
  ...
  },
  {
    ...
    location: "Paris, France",
    description:
      "Hugging Face is an NLP startup with a focus on chatbots. They are also known as a platform for pre-trained Deep Learning models. Hugging Face does not produce the models themselves, but offers a platform that is also used by Facebook, Google, etc. to provide pre-trained models.",
  },
  {
    name: "Initiative Unser Dialog (nicht auf Englisch verfügbar/ zu wenige informationen)",
    tags: [],
    link: "https://unserdialog.org/unser-dialog/unser-dialog-ueber-kuenstliche-intelligenz/",
    location: "Kressbronn, Germany",
    description:
      "Die Vortragsreihe zu KI unter dem Titel “Unser Dialog über Künstliche Intelligenz” möchte Menschen das Thema KI näherbringen und im Zuge dessen Möglichkeiten für den gesellschaftlichen Austausch ebenso wie Handlungsoptionen aufzeigen.",
  },
  {
    name: "iRights.Lab",
  ...
  },
  {
    ...
    description:
      "Founded in 2018, Luminate is a global philanthropic organization with a mission to empower people and institutions to work together to build a just and fair society. It does this by funding and supporting nonprofit and for-profit organizations, and by advocating for policies and actions that help people participate in and shape the issues that affect their lives, and that make those in power more transparent, responsive, and accountable. Luminate focuses on creating impact in four interconnected areas: Citizen Participation, Data and Digital Rights, Financial Transparency, and Independent Media. In the area of AI, Luminate promotes the AI Ethics and Governance Initiative, led by MIT and the Berkmann Klein Center, which targets public interest AI.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Microsoft AI for Good supports AI projects in the programs “AI for Earth“, “Health”. “Accessibility” and “Humanitarian Action”. Microsoft is headquartered in the USA, but projects are funded internationally, including in Germany. Some of the case studies listed, for example, receive or received funding.",
  },
  {
    ...
    description:
      "The Mozilla Foundation has a project on trustworthy AI that takes several approaches. Among them, for example, is #YouTubeRegrets, a project in which civilians can report when they have seen disturbing suggestions displayed on YouTube (https://foundation.mozilla.org/de/youtube/regrets/).",
  },
  {
    name: "Netzwerk KI der Arbeits- und Sozialveraltung (rausgelassen (von Judith))",
    tags: ["Politics"],
    link: "",
    location: "Berlin, Germany",
    description:
      "BMAS, Fachdialog zur Entwicklung von Strategien für ein gutes Mensch-Technik-Verhältnis beim Einsatz von KI in Arbeitsprozessen",
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "This initiative of the Federal Ministry of Labour and Social Affairs analyses, develops and evaluates AI systems and AI Literacy in the work context.",
  },
  {
  ...
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "Prototypefund supports software projects that serve the common good. There is no specific focus on AI, but many AI projects are funded.",
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "In free workshops, stakeholders from business, administration and politics are provided with assistance for the responsible use of AI. The program also plans to reflect on the experiences gained from these workshops and to develop proposals for action for political decision-makers.",
  },
  {
    name: "Stifterverband -> ist oben unter AI Campus (The Stifterverband)",
    tags: ["Funding"],
    link: "https://www.stifterverband.org/ki-campus",
    location: "Essen, Germany",
    description:
      "Der KI-Campus stellt ein Lehrangebot zu KI bereit, welches an eine breite Zielgruppe gerichtet ist und je nach gewähltem kostenlosen Kurs keine bis höhere inhaltliche Vorkenntnisse voraussetzt. Die Lehrplattform ermöglicht dabei sowohl Zugang zu spezifisch vom KI-Campus entwickelten Kursen, sogenannten KI-Campus-Originalen als auch zu ausgewählten externen Inhalten.",
  },
  {
  ...
  },
  {
    ...
    location: "Bonn, Germany",
    description:
      "The Sustainable AI Lab creates a space where a group of researchers from different fields can collaborate and share ideas on the environmental, social, and economic costs of designing, developing, and using AI in society.",
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "The Technology Foundation supports technology projects. It does not focus specifically on AI, but AI projects can also be funded. It is the umbrella organization for programs such as City Lab, KulturBDigital or COMo for CO2 monitoring in indoor spaces.",
  },
  {
  ...
  },
  {
    ...
    description:
      "The project “Ethics of Algorithms” deals with the social consequences of algorithmic decision making. The aim is to contribute to a design of algorithmic systems that leads to more participation. ",
  },
  {
  ...
  },
  {
    ...
    location: "Berlin, Germany",
    description:
      "The Artificial Intelligence in Labor and Social Administration Network of the BMAS exchanges views on how artificial intelligence (AI) can be used in administration. The aim is to develop self-committed guidelines for practice that ensure responsible handling of AI. ",
  },
  {
    name: "Thüringer Zentrum für Lernende Systeme und Robotik",
    tags: [],
    link: "https://tzlr.de/",
    location: "Arnstadt-Ilmenau, Germany",
    description:
      "The TZLR is a Thuringian association that acts as a network and contact point for scientific institutions and entrepreneurs as well as entrepreneurial alliances, and also offers consulting services and the organization of seminars and workshops.",
  },
  {
    name: "TU Darmstadt",
    tags: ["Research"],
    ...
    description:
      "The TU Darmstadt advertises a high level of interdisciplinarity with regard to AI research there, for example through its close ties to the cognitive sciences. Through the research fields on search and rescue procedures, the use of AI in agriculture and in relation to learning procedures, the research covers a broad field. For example, a project on the prediction of leaks and burst pipes arose from this framework and demonstrates the potential public benefit.",
  },
  {
    ...
    description:
      "In particular, the Tübingen AI Center carries out outreach and educational work through offerings such as the Federal Artificial Intelligence Competition, an online course on artificial intelligence, and support for initiatives such as IT4Kids and KI macht Schule.",
  },
  {
