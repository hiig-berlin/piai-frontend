      ...
      <AboutPage
        {...{
          ...
          content: `<h3>What is the Simba Text Assistant?</h3>
            ...
            We trained and evaluated the model that provides these simplifications with news articles; that is why it works better for these types of web content. The browser extension also offers the opportunity to submit your feedback on the summary that Simba produces.</p>
            
            <p>Please note that we cannot guarantee that the model will always produce factual information. Simba is based on a text generation model, and as other generation models, it can in some cases ‘hallucinate’. Please compare the output to the input to verify the content.</p>
            ...
            We used German-language newspaper articles that have been simplified to fine-tune the foundation model Llama-3-8B-Instruct. We use articles from the Austrian Press Agency, which have been simplified by professional translators. They are simplified to the levels B1 and A2 on the Common European Framework of Reference for Languages (CEFR). A sample of the dataset can be found <a href="https://github.com/fhewett/apa-rst/tree/main/original_texts">here</a>.
