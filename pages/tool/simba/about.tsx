      ...
      <AboutPage 
        {...{
          ...
          content:
            ...
            <h4>How does a summarization model work in general?</h4>
            There are different ways of automatically creating a summarization, Simba is based on a so-called “text generation” model. These text generation models are also referred to as Large Language Models or foundation models: ChatGPT and Llama are examples of these. They are very large neural networks that are fed with a large amount of text data. These networks are trained to calculate what word is most likely to come next in a sequence. 
            
            <h4>What data did we use?</h4>
            We used German-language newspaper articles that have been simplified to fine-tune the foundation model XXX. We use articles from the Austrian Press Agency, which have been simplified by professional translators. They are simplified to the levels B1 and A2 on the Common European Framework of Reference for Languages (CEFR). A sample of the dataset can be found <a href="https://github.com/fhewett/apa-rst/tree/main/original_texts">here</a>.
            ...
            Our code repository can be found es (CEFR). A sample of the dataset can be found <a href="https://github.com/fhewett/simba">here</a> and a sample of the data can be found es (CEFR). A sample of the dataset can be found <a href="https://github.com/fhewett/apa-rst/tree/main/original_texts">here</a>. If your question is not answered, feel free to file an issue on our es (CEFR). A sample of the dataset can be found <a href="https://github.com/fhewett/simba">Simba repository</a>.
            </p>
            `,
          contentSimple:
            `<h3>What is the “Simba Text Assistant”?</h3>
